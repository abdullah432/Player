...
public class TrackSelectionV extends LinearLayout {

    private final int selectableItemBackgroundResourceId;
    private final LayoutInflater inflater;
    private final CheckedTextView disableView;
    private final CheckedTextView defaultView;
    private final TrackSelectionV.ComponentListener componentListener;
    ...
    public static  @Nullable SelectionOverride override;

    public interface onOkListener{
        void onOkClick();
    }

    static onOkListener mOnOkListener;
     ...
     */
    public static Pair<AlertDialog, TrackSelectionV> getDialog(
            final Activity activity,
            CharSequence title,
            DefaultTrackSelector trackSelector,
            int rendererIndex,
            final onOkListener listener
    ) {
        AlertDialog.Builder builder = new AlertDialog.Builder(activity);

        // Inflate with the builder's context to ensure the correct style is used.
        LayoutInflater dialogInflater = LayoutInflater.from(builder.getContext());
        View dialogView = dialogInflater.inflate(R.layout.exo_track_select_dialog, null);

        final TrackSelectionV selectionView = dialogView.findViewById(R.id.exo_track_selection_view);
        selectionView.init(trackSelector, rendererIndex,listener);
        Dialog.OnClickListener okClickListener =
                new Dialog.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        //player will be stop playing when we click on TrackSelectionV dialog
    ...
    public TrackSelectionV(Context context) {
        this(context, null);
    }

    public TrackSelectionV(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @SuppressWarnings("nullness")
    public TrackSelectionV(
        ...
        componentListener = new TrackSelectionV.ComponentListener();
    ...
    public void setShowAutoOption(boolean shownAutoOption){
        defaultView.setVisibility(shownAutoOption ? View.VISIBLE : View.GONE);
    }
     ...
     * @param rendererIndex The index of the renderer.
     */
    public void init(DefaultTrackSelector trackSelector, int rendererIndex, onOkListener listener) {
...
//            trackViews[0][0].setChecked(true);
//        }
        if (override == null){
            if (trackViews.length != 0){
                trackViews[0][0].setChecked(!isDisabled);
            }
        }else {
...
//    }
    ...
    private class ComponentListener implements OnClickListener {
        ...
        public void onClick(View view) {
            TrackSelectionV.this.onClick(view);
        }
    }
}