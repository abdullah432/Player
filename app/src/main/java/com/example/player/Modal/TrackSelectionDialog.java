...
public final class TrackSelectionDialog extends DialogFragment {
  ...
  public List<SelectionOverride> getOverrides(int rendererIndex) {
    TrackSelectionViewFragment rendererView = tabFragments.get(rendererIndex);
    return rendererView == null ? Collections.<SelectionOverride>emptyList() : rendererView.overrides;
  }
  ...
  public static final class TrackSelectionViewFragment extends Fragment
    ...
    public void init(
      ...
      this.overrides =
          initialOverride == null
              ? Collections.<SelectionOverride>emptyList()
    ...
    public View onCreateView(
      ...
      View rootView =
          inflater.inflate(
              R.layout.track_dialog_box, container, /* attachToRoot= */ false);
...
//      trackSelectionView.init(trackSelector, isDisabled);
      return rootView;
    }
